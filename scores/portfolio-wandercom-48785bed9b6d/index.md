---
title: "Agents First Score — Wander.com"
description: "Score: 20/100 · Level 1 (Agent as Afterthought). Wander.com is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
image: /scores/portfolio-wandercom-48785bed9b6d/og.png
author: Joshua Baer
---

## Agents First Score — Wander.com

**Score: 20/100 · Level 1 (Agent as Afterthought)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. Wander.com's public site at [https://www.wander.com/](https://www.wander.com/) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use Wander.com's product on behalf of a user.

### Dimension breakdown

- 🟡 **Discoverability** (5/25) — robots.txt exists but does not address AI agents specifically
- 🟡 **Content Accessibility** (5/20) — No markdown content negotiation
- 🟡 **Bot Access Control** (10/15) — Content-Signal directive declared: ai-train=yes, search=yes, ai-input=yes
