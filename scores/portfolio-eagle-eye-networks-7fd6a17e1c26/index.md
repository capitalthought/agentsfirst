---
title: "Agents First Score — Eagle Eye Networks"
description: "Score: 10/100 · Level 0 (No agent access). Eagle Eye Networks is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
...
## Agents First Score — Eagle Eye Networks

**Score: 10/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. Eagle Eye Networks's public site at [https://www.een.com](https://www.een.com) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use Eagle Eye Networks's product on behalf of a user.
