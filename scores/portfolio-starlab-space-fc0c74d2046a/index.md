---
title: "Agents First Score — Starlab Space"
description: "Score: 5/100 · Level 0 (No agent access). Starlab Space is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
image: /scores/portfolio-starlab-space-fc0c74d2046a/og.png
author: Joshua Baer
---

## Agents First Score — Starlab Space

**Score: 5/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. Starlab Space's public site at [https://starlab-space.com/](https://starlab-space.com/) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use Starlab Space's product on behalf of a user.

### Dimension breakdown

- 🟡 **Discoverability** (5/25) — robots.txt addresses 2 AI agents: GPTBot, CCBot
