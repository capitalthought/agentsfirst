---
title: "Agents First Score — TAE"
description: "Score: 0/100 · Level 0 (No agent access). TAE is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
...
## Agents First Score — TAE

**Score: 0/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. TAE's public site at [https://www.tae.com](https://www.tae.com) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use TAE's product on behalf of a user.
