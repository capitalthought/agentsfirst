---
title: "Agents First Score — X-Bow Systems"
description: "Score: 0/100 · Level 0 (No agent access). X-Bow Systems is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
...
## Agents First Score — X-Bow Systems

**Score: 0/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. X-Bow Systems's public site at [http://www.xbowsystems.com](http://www.xbowsystems.com) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use X-Bow Systems's product on behalf of a user.
