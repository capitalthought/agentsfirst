---
title: "Agents First Score — Colossal Biosciences"
description: "Score: 5/100 · Level 0 (No agent access). Colossal Biosciences is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
image: /scores/portfolio-colossal-biosciences-38737036b424/og.png
author: Joshua Baer
---

## Agents First Score — Colossal Biosciences

**Score: 5/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. Colossal Biosciences's public site at [https://colossal.com/](https://colossal.com/) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use Colossal Biosciences's product on behalf of a user.
