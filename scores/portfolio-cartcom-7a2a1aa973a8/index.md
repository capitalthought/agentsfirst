---
title: "Agents First Score — Cart.com"
description: "Score: 5/100 · Level 0 (No agent access). Cart.com is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
image: /scores/portfolio-cartcom-7a2a1aa973a8/og.png
author: Joshua Baer
---

## Agents First Score — Cart.com

**Score: 5/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. Cart.com's public site at [https://cart.com](https://cart.com) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use Cart.com's product on behalf of a user.
