---
title: "Agents First Score — Apptronik Inc."
description: "Score: 0/100 · Level 0 (No agent access). Apptronik Inc. is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
image: /scores/portfolio-apptronik-inc-a5b2cf06b2db/og.png
author: Joshua Baer
---

## Agents First Score — Apptronik Inc.

**Score: 0/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. Apptronik Inc.'s public site at [https://apptronik.com/](https://apptronik.com/) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use Apptronik Inc.'s product on behalf of a user.
...
- ⚠️ **Bot Access Control** (0/15) — No robots.txt analysis available
