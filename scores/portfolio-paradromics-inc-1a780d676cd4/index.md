---
title: "Agents First Score — Paradromics Inc."
description: "Score: 5/100 · Level 0 (No agent access). Paradromics Inc. is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
image: /scores/portfolio-paradromics-inc-1a780d676cd4/og.png
author: Joshua Baer
---

## Agents First Score — Paradromics Inc.

**Score: 5/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. Paradromics Inc.'s public site at [https://www.paradromics.com/](https://www.paradromics.com/) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use Paradromics Inc.'s product on behalf of a user.
