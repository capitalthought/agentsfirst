---
title: "Agents First Score — Saronic Technologies"
description: "Score: 0/100 · Level 0 (No agent access). Saronic Technologies is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
image: /scores/portfolio-saronic-technologies-e39f8fbcf91b/og.png
author: Joshua Baer
---

## Agents First Score — Saronic Technologies

**Score: 0/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. Saronic Technologies's public site at [https://www.saronic.com/.](https://www.saronic.com/.) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use Saronic Technologies's product on behalf of a user.

### Dimension breakdown

- ⚠️ **Discoverability** (0/25) — No robots.txt
