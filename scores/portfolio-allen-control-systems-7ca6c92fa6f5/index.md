---
title: "Agents First Score — Allen Control Systems"
description: "Score: 5/100 · Level 0 (No agent access). Allen Control Systems is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
...
## Agents First Score — Allen Control Systems

**Score: 5/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. Allen Control Systems's public site at [https://www.allencontrolsystems.com/](https://www.allencontrolsystems.com/) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use Allen Control Systems's product on behalf of a user.
