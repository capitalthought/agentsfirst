---
title: "Agents First Score — zenbusiness"
description: "Score: 10/100 · Level 0 (No agent access). zenbusiness is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
image: /scores/portfolio-zenbusiness-3d193af9d692/og.png
author: Joshua Baer
---

## Agents First Score — zenbusiness

**Score: 10/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. zenbusiness's public site at [https://www.zenbusiness.com](https://www.zenbusiness.com) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use zenbusiness's product on behalf of a user.
