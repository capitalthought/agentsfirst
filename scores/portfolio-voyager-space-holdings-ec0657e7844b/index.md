---
title: "Agents First Score — Voyager Space Holdings"
description: "Score: 10/100 · Level 0 (No agent access). Voyager Space Holdings is a Capital Factory portfolio company. This private agent-readiness audit shows what an agent finds when it tries to discover their product."
noindex: true
sitemap: false
...
## Agents First Score — Voyager Space Holdings

**Score: 10/100 · Level 0 (No agent access)** · scored against rubric v0.2.0 on 2026-05-07.

This is a private audit prepared as part of a Capital Factory portfolio review. Voyager Space Holdings's public site at [https://voyagertechnologies.com/](https://voyagertechnologies.com/) was scored against the [Agents First framework](https://agentsfirst.dev) — eight implementation principles plus five discovery dimensions. The score reflects what an agent finds when it tries to discover and use Voyager Space Holdings's product on behalf of a user.

### Dimension breakdown

- 🟡 **Discoverability** (5/25) — robots.txt addresses 4 AI agents: GPTBot, ClaudeBot, Google-Extended, CCBot
- ⚠️ **Content Accessibility** (0/20) — No markdown content negotiation
- 🟡 **Bot Access Control** (5/15) — AI policy implicit via 4 per-bot rules — consider adding a Content-Signal directive for machine-r…
...
3. **+20pts (content-accessibility)** — Serve text/markdown when the Accept header asks for it. Publish sitemap.xml and an OpenAPI document at /openapi.json.
